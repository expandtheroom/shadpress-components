...
<div <?= $this->component_attrs() ?>
     ...
     data-loop="<?= esc_attr($this->loop ? 'true' : 'false') ?>"
     data-autoplay="<?= esc_attr($this->autoplay ? 'true' : 'false') ?>"
     data-autoplay-delay="<?= esc_attr((string) $this->autoplay_delay) ?>"
    ...
    <div data-slot="carousel-viewport" class="relative overflow-hidden">
        ...
        <div data-slot="carousel-track"
             x-ref="track"
             class="flex overflow-x-scroll snap-x snap-mandatory scroll-smooth [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        ...
        <button data-slot="carousel-prev"
                ...
                class="absolute left-3 top-1/2 -translate-y-1/2 z-10 inline-flex items-center justify-center size-8 rounded-full">
        ...
        <button data-slot="carousel-next"
                ...
                class="absolute right-3 top-1/2 -translate-y-1/2 z-10 inline-flex items-center justify-center size-8 rounded-full">
