...
<div <?= $this->component_attrs() ?>
     ...
     data-label="<?= esc_attr($this->label) ?>"
    ...
    <?php if ($this->label): ?>
        <label data-slot="date-picker-label"
               :for="inputId"
    ...
    <button type="button"
            ...
            class="inline-flex items-center gap-2 w-full min-w-60 h-9 rounded-md border px-3 py-2 text-sm text-left">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" class="shrink-0 opacity-60"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/></svg>
